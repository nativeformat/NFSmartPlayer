...
/**
 * A plugin that can produce a sine wave signal
 */
class SineWavePlugin : public Plugin {
 public:
  SineWavePlugin(const nfgrapher::contract::SineNodeInfo &sine_node,
                 int channels, double samplerate);
  virtual ~SineWavePlugin();
