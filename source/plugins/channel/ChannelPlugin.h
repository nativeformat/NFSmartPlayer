...
extern const std::string ChannelPluginIdentifier;

/**
 * A plugin that can isolate different channels
 */
class ChannelPlugin : public Plugin {
 public:
  ChannelPlugin(const nfgrapher::Node &grapher_node, int channels,
                double samplerate,
