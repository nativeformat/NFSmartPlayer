...
/**
 * A plugin that can control the amount of delay on an audio signal
 */
class DelayPlugin : public Plugin {
 public:
  DelayPlugin(const nfgrapher::contract::DelayNodeInfo &delay_node,
 ...
 private:
  ...
  std::shared_ptr<param::Param> _delay_time;
};
